...
/* Define to 1 if you have the <linux/vm_sockets_diag.h> header file. */
#define HAVE_LINUX_VM_SOCKETS_DIAG_H 1

/* Define to 1 if you have the <linux/vm_sockets.h> header file. */
#define HAVE_LINUX_VM_SOCKETS_H 1

/* Define to 1 if netcap advanced mode can be built. */
#define HAVE_NETCAP_ADVANCED 1
...
#define PACKAGE_STRING "libcap-ng 0.9.3"
